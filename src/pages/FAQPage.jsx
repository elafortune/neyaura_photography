    ...
    questions: [
      {
        ...
        a: "La réservation se fait simplement via le formulaire de contact ou en message direct sur Instagram. Après échange sur votre projet, je vous envoie un devis personnalisé. La séance est confirmée à réception d'un acompte de 50 %.",
      },
      {
      ...
      },
      {
        ...
        a: "Oui, un acompte de 50 % est demandé à la confirmation de la réservation. Il permet de bloquer la date dans mon agenda et est déduit du montant total.",
      },
      {
